  ...
  const features = [
    {
      ...
      title: "Join BWA",
      description:
        "A pseudo-Latin text used in web design, layout, and printing inplace of things to emphasise design.",
    },
    {
  ...
  const listPricing = [
    {
      ...
      features: [
        { isChecked: true, content: "Excepteur sint accessat velit" },
        { isChecked: true, content: "Excepteur sint accessat velit" },
        { isChecked: true, content: "Excepteur sint accessat velit" },
        { isChecked: false, content: "Excepteur sint accessat velit" },
        { isChecked: false, content: "Excepteur sint accessat velit" },
      ],
    },
    {
